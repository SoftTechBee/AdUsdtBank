...
public partial class Member_Default : System.Web.UI.Page
{
    ...
    private void loadPack()
    {
        try
        {
            string sql = "select product,toroi,descrption,Imgurl,MaxDays,PerDays,PackID,CAST(mrp as int) as min,CAST(soldrate as int) as SoldRate from tblproduct where packid!=1 ";
    ...
    protected void repPack_ItemCommand(object source, RepeaterCommandEventArgs e)
    {
        if (e.CommandName == "Click")
        {
            ...
            Label lbamount = e.Item.FindControl("lbamountmin") as Label;
