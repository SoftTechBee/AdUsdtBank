<%@ Page Title="" Language="C#" MasterPageFile="~/Member/MasterPage.master" AutoEventWireup="true" CodeFile="rptDividentIncome.aspx.cs" Inherits="User_Default2" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
     ...
     <div class="card">
            <div class="card-header">
              <h5 class="card-title"> Divident Income</h5>
...
<asp:TemplateField HeaderText="#">
                ...
                <asp:boundfield DataField="Remark"  HeaderText="Type of Income"></asp:boundfield>
                <asp:boundfield DataField="Credit" HeaderText="Amount"></asp:boundfield>
