...
AutoGenerateColumns="False" CellPadding="10" PageSize="100"  Font-Size="Large" CssClass="table table-bordered"
...
<asp:TemplateField HeaderText="#">
        <HeaderStyle CssClass="header-yellow-border" />
                ...
                <asp:boundfield DataField="username" HeaderText="UserName">  
                    <HeaderStyle CssClass="header-yellow-border" /></asp:boundfield>
                <asp:boundfield DataField="date" DataFormatString="{0:d}" HeaderText="Date">
                        <HeaderStyle CssClass="header-yellow-border" />
                </asp:boundfield>
                <asp:boundfield DataField="Remark"  HeaderText="Type of Income">
                        <HeaderStyle CssClass="header-yellow-border" />
                </asp:boundfield>
