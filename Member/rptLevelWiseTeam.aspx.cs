...
public partial class User_rptLevelWiseTeam : System.Web.UI.Page
{
    ...
    public void loadaccount(string username)
    {
        try
        {
            string sql = "select Username,[Count] as AchiveTeam,TragetMember,levelno from tblpoollevel where username='" + username + "' order by levelno asc";
