...
public partial class User_Default : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            if (SessionData.Get<string>("newuser") != null)
            {
                ...
                lbtotalteam.Text = objdashboard.PoolTeam(UserName, "A");
                lbLeftteam.Text = objdashboard.PoolTeam(UserName, "L");
                lbRightteam.Text = objdashboard.PoolTeam(UserName, "R");
    ...
    public static string TreeDetails(string UserId)
    {
        ...
        //{
            ...
            clsConnection objCon = new clsConnection();
            string sql = "exec GetBinaryTreeView '" + UserId + "','1','D' ";
