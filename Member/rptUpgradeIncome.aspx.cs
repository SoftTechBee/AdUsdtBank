...
public partial class User_Default2 : System.Web.UI.Page
{
    ...
    public void loadaccount(string username)
    {
        try
        {
            string sql = "select a.username,a.credit,a.debit,a.date,a.remark from account a inner join  register r on  a.username=r.username and r.status='Active' and a.valu='Upgrade' and  a.username='" + username + "'";
